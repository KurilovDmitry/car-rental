...
<div role="tabpanel">
    ...
    <div class="tab-content">
        <div role="tabpanel" class="tab-pane active" id="all">
            <?php printCustomers($data['all_customers']) ?>
        </div>

        <div role="tabpanel" class="tab-pane" id="regular">
            <?php printCustomers($data['regular_customers']) ?>
        </div>

        <div role="tabpanel" class="tab-pane" id="most-profitable">
            <?php printCustomers($data['most_profitable_customers']) ?>
        </div>
    </div>
